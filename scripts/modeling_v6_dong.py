#!/usr/bin/env python3
"""모델링 v6: OLS + RF + XGBoost + SHAP (2019-2025, 추가변수: 공원수,도서관수,학원수,어린이집수)"""
...
PLOTS_DIR = os.path.join(RESULTS_DIR, 'plots_v6_dong')
...
def main():
    ...
    # Save results
    with open(os.path.join(RESULTS_DIR, 'modeling_v6_dong_results.json'), 'w') as f:
        json.dump(results, f, ensure_ascii=False, indent=2)
    print(f"\n결과 저장: modeling_v6_dong_results.json")
