...
PLOTS_DIR = os.path.join(RESULTS_DIR, 'plots_v5_dong')
...
def main():
    ...
    # Save results
    with open(os.path.join(RESULTS_DIR, 'modeling_v5_dong_results.json'), 'w') as f:
        json.dump(results, f, ensure_ascii=False, indent=2)
    print(f"\n결과 저장: modeling_v5_dong_results.json")
