# 서울시 아파트 단위면적당 매매가격 구조 분석

> 한양대학교 부동산융합대학원 도시·부동산빅데이터전공 석사학위논문

## 연구 개요

본 프로젝트는 서울특별시 아파트 단위면적당 매매가격 구조를 거리 기반 접근성과 시공간 이질성의 관점에서 분석한다. 2019년 1월부터 2025년 12월까지의 아파트 실거래 391,826건과 8,601개 단지 좌표를 사용하며, 종속변수는 `log(㎡당 거래가격)`이다.
